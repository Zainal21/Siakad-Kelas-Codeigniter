  ...
  <footer class="main-footer">
    <strong>Copyright &copy;2019 <a href="">Siakad SMK </a>.</strong>
    All rights reserved.
    <div class="float-right d-none d-sm-inline-block">
      <b>Version 00.1</b> Zainal Arifin
    </div>
  </footer>
...
<script src="<?= base_url(); ?>assest/plugins/datatables-bs4/js/dataTables.bootstrap4.js"></script>
<script>
  $(function () {
    $("#example1").DataTable();
  });
